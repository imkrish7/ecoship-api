...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/imkrish7/ecoship-api/gen/rpc/seller/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SellerServiceGetSellerProcedure = "/seller.v1.SellerService/GetSeller"
	// SellerServiceDeactivateSellerProcedure is the fully-qualified name of the SellerService's
	// DeactivateSeller RPC.
	SellerServiceDeactivateSellerProcedure = "/seller.v1.SellerService/DeactivateSeller"
	// SellerServiceUpdateKycStatusProcedure is the fully-qualified name of the SellerService's
	// UpdateKycStatus RPC.
	SellerServiceUpdateKycStatusProcedure = "/seller.v1.SellerService/UpdateKycStatus"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	sellerServiceServiceDescriptor                = v1.File_rpc_seller_v1_seller_proto.Services().ByName("SellerService")
...
// GetSeller calls seller.v1.SellerService.GetSeller.
...
// DeactivateSeller calls seller.v1.SellerService.DeactivateSeller.
...
// UpdateKycStatus calls seller.v1.SellerService.UpdateKycStatus.
...
func (UnimplementedSellerServiceHandler) GetSeller(context.Context, *connect.Request[v1.GetSellerRequest]) (*connect.Response[v1.GetSellerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("seller.v1.SellerService.GetSeller is not implemented"))
}
...
func (UnimplementedSellerServiceHandler) DeactivateSeller(context.Context, *connect.Request[v1.DeactivateSellerRequest]) (*connect.Response[v1.DeactivateSellerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("seller.v1.SellerService.DeactivateSeller is not implemented"))
}
...
func (UnimplementedSellerServiceHandler) UpdateKycStatus(context.Context, *connect.Request[v1.UpdateKycStatusRequest]) (*connect.Response[v1.UpdateKycStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("seller.v1.SellerService.UpdateKycStatus is not implemented"))
}
