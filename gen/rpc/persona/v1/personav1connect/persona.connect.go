...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/imkrish7/ecoship-api/gen/rpc/perosona/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PersonaServiceName = "persona.v1.PersonaService"
)
...
const (
	...
	// CreatePersona RPC.
	PersonaServiceCreatePersonaProcedure = "/persona.v1.PersonaService/CreatePersona"
	// PersonaServiceVerifyAccountProcedure is the fully-qualified name of the PersonaService's
	// VerifyAccount RPC.
	PersonaServiceVerifyAccountProcedure = "/persona.v1.PersonaService/VerifyAccount"
	// PersonaServiceResendVerifyLinkProcedure is the fully-qualified name of the PersonaService's
	// ResendVerifyLink RPC.
	PersonaServiceResendVerifyLinkProcedure = "/persona.v1.PersonaService/ResendVerifyLink"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	personaServiceServiceDescriptor                = v1.File_rpc_persona_v1_persona_proto.Services().ByName("PersonaService")
...
// PersonaServiceClient is a client for the persona.v1.PersonaService service.
...
// NewPersonaServiceClient constructs a client for the persona.v1.PersonaService service. By
...
// CreatePersona calls persona.v1.PersonaService.CreatePersona.
...
// VerifyAccount calls persona.v1.PersonaService.VerifyAccount.
...
// ResendVerifyLink calls persona.v1.PersonaService.ResendVerifyLink.
...
// PersonaServiceHandler is an implementation of the persona.v1.PersonaService service.
...
func NewPersonaServiceHandler(svc PersonaServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/persona.v1.PersonaService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPersonaServiceHandler) CreatePersona(context.Context, *connect.Request[v1.CreatePersonaRequest]) (*connect.Response[v1.CreatePersonaResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("persona.v1.PersonaService.CreatePersona is not implemented"))
}
...
func (UnimplementedPersonaServiceHandler) VerifyAccount(context.Context, *connect.Request[v1.VerifyAccountRequest]) (*connect.Response[v1.VerifyAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("persona.v1.PersonaService.VerifyAccount is not implemented"))
}
...
func (UnimplementedPersonaServiceHandler) ResendVerifyLink(context.Context, *connect.Request[v1.ResendVerifyLinkRequest]) (*connect.Response[v1.ResendVerifyLinkResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("persona.v1.PersonaService.ResendVerifyLink is not implemented"))
}
