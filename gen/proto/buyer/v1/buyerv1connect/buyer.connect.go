...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/imkrish7/ecoship-api/gen/proto/buyer/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	BuyerServiceName = "proto.buyer.v1.BuyerService"
)
...
const (
	...
	// RPC.
	BuyerServiceCreateBuyerProcedure = "/proto.buyer.v1.BuyerService/CreateBuyer"
	// BuyerServiceUpdateBuyerProcedure is the fully-qualified name of the BuyerService's UpdateBuyer
	// RPC.
	BuyerServiceUpdateBuyerProcedure = "/proto.buyer.v1.BuyerService/UpdateBuyer"
	// BuyerServiceGetBuyerProcedure is the fully-qualified name of the BuyerService's GetBuyer RPC.
	BuyerServiceGetBuyerProcedure = "/proto.buyer.v1.BuyerService/GetBuyer"
	// BuyerServiceDeactivateBuyerProcedure is the fully-qualified name of the BuyerService's
	// DeactivateBuyer RPC.
	BuyerServiceDeactivateBuyerProcedure = "/proto.buyer.v1.BuyerService/DeactivateBuyer"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	buyerServiceServiceDescriptor               = v1.File_proto_buyer_v1_buyer_proto.Services().ByName("BuyerService")
...
// BuyerServiceClient is a client for the proto.buyer.v1.BuyerService service.
...
// NewBuyerServiceClient constructs a client for the proto.buyer.v1.BuyerService service. By
...
// CreateBuyer calls proto.buyer.v1.BuyerService.CreateBuyer.
...
// UpdateBuyer calls proto.buyer.v1.BuyerService.UpdateBuyer.
...
// GetBuyer calls proto.buyer.v1.BuyerService.GetBuyer.
...
// DeactivateBuyer calls proto.buyer.v1.BuyerService.DeactivateBuyer.
...
// BuyerServiceHandler is an implementation of the proto.buyer.v1.BuyerService service.
...
func NewBuyerServiceHandler(svc BuyerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.buyer.v1.BuyerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedBuyerServiceHandler) CreateBuyer(context.Context, *connect.Request[v1.CreateBuyerRequest]) (*connect.Response[v1.CreateBuyerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.buyer.v1.BuyerService.CreateBuyer is not implemented"))
}
...
func (UnimplementedBuyerServiceHandler) UpdateBuyer(context.Context, *connect.Request[v1.UpdateBuyerRequest]) (*connect.Response[v1.UpdateBuyerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.buyer.v1.BuyerService.UpdateBuyer is not implemented"))
}
...
func (UnimplementedBuyerServiceHandler) GetBuyer(context.Context, *connect.Request[v1.GetBuyerRequest]) (*connect.Response[v1.GetBuyerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.buyer.v1.BuyerService.GetBuyer is not implemented"))
}
...
func (UnimplementedBuyerServiceHandler) DeactivateBuyer(context.Context, *connect.Request[v1.DeactivateBuyerRequest]) (*connect.Response[v1.DeactivateBuyerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.buyer.v1.BuyerService.DeactivateBuyer is not implemented"))
}
