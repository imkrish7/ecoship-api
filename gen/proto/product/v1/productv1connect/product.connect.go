...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/imkrish7/ecoship-api/gen/proto/product/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// GetProductById RPC.
	ProductServiceGetProductByIdProcedure = "/proto.product.v1.ProductService/GetProductById"
	// ProductServiceRemoveProductByIdProcedure is the fully-qualified name of the ProductService's
	// RemoveProductById RPC.
	ProductServiceRemoveProductByIdProcedure = "/proto.product.v1.ProductService/RemoveProductById"
	// ProductServiceUpdateProductByIdProcedure is the fully-qualified name of the ProductService's
	// UpdateProductById RPC.
	ProductServiceUpdateProductByIdProcedure = "/proto.product.v1.ProductService/UpdateProductById"
	// ProductServiceGetProductsProcedure is the fully-qualified name of the ProductService's
	// GetProducts RPC.
	ProductServiceGetProductsProcedure = "/proto.product.v1.ProductService/GetProducts"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	productServiceServiceDescriptor                 = v1.File_proto_product_v1_product_proto.Services().ByName("ProductService")
...
// GetProductById calls proto.product.v1.ProductService.GetProductById.
...
// RemoveProductById calls proto.product.v1.ProductService.RemoveProductById.
...
// UpdateProductById calls proto.product.v1.ProductService.UpdateProductById.
...
// GetProducts calls proto.product.v1.ProductService.GetProducts.
...
func (UnimplementedProductServiceHandler) GetProductById(context.Context, *connect.Request[v1.GetProductByIdRequest]) (*connect.Response[v1.GetProductByIdResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.product.v1.ProductService.GetProductById is not implemented"))
}
...
func (UnimplementedProductServiceHandler) RemoveProductById(context.Context, *connect.Request[v1.RemoveProductByIdRequest]) (*connect.Response[v1.RemoveProductByIdResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.product.v1.ProductService.RemoveProductById is not implemented"))
}
...
func (UnimplementedProductServiceHandler) UpdateProductById(context.Context, *connect.Request[v1.UpdateProductByIdRequest]) (*connect.Response[v1.UpdateProductByIdResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.product.v1.ProductService.UpdateProductById is not implemented"))
}
...
func (UnimplementedProductServiceHandler) GetProducts(context.Context, *connect.Request[v1.GetProductsRequest]) (*connect.Response[v1.GetProductsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.product.v1.ProductService.GetProducts is not implemented"))
}
