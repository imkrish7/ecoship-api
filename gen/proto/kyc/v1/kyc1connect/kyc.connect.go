...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/imkrish7/ecoship-api/gen/kyc/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	KycServiceName = "proto.kyc.v1.KycService"
)
...
const (
	...
	KycServiceCompleteKycProcedure = "/proto.kyc.v1.KycService/CompleteKyc"
	// KycServiceUpdateKycProcedure is the fully-qualified name of the KycService's UpdateKyc RPC.
	KycServiceUpdateKycProcedure = "/proto.kyc.v1.KycService/UpdateKyc"
	// KycServiceDeleteKycProcedure is the fully-qualified name of the KycService's DeleteKyc RPC.
	KycServiceDeleteKycProcedure = "/proto.kyc.v1.KycService/DeleteKyc"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	kycServiceServiceDescriptor           = v1.File_proto_kyc_v1_kyc_proto.Services().ByName("KycService")
...
// KycServiceClient is a client for the proto.kyc.v1.KycService service.
...
// NewKycServiceClient constructs a client for the proto.kyc.v1.KycService service. By default, it
...
// CompleteKyc calls proto.kyc.v1.KycService.CompleteKyc.
...
// UpdateKyc calls proto.kyc.v1.KycService.UpdateKyc.
...
// DeleteKyc calls proto.kyc.v1.KycService.DeleteKyc.
...
// KycServiceHandler is an implementation of the proto.kyc.v1.KycService service.
...
func NewKycServiceHandler(svc KycServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.kyc.v1.KycService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedKycServiceHandler) CompleteKyc(context.Context, *connect.Request[v1.CompleteKycRequest]) (*connect.Response[v1.CompleteKycResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.kyc.v1.KycService.CompleteKyc is not implemented"))
}
...
func (UnimplementedKycServiceHandler) UpdateKyc(context.Context, *connect.Request[v1.UpdateKycRequest]) (*connect.Response[v1.UpdateKycResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.kyc.v1.KycService.UpdateKyc is not implemented"))
}
...
func (UnimplementedKycServiceHandler) DeleteKyc(context.Context, *connect.Request[v1.DeleteKycRequest]) (*connect.Response[v1.DeleteKycResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.kyc.v1.KycService.DeleteKyc is not implemented"))
}
