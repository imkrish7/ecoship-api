...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/imkrish7/ecoship-api/gen/proto/auth/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// RPC.
	AuthServiceLoginServiceProcedure = "/proto.auth.v1.AuthService/LoginService"
	// AuthServiceSignupServiceProcedure is the fully-qualified name of the AuthService's SignupService
	// RPC.
	AuthServiceSignupServiceProcedure = "/proto.auth.v1.AuthService/SignupService"
)
...
// LoginService calls proto.auth.v1.AuthService.LoginService.
...
// SignupService calls proto.auth.v1.AuthService.SignupService.
...
func (UnimplementedAuthServiceHandler) LoginService(context.Context, *connect.Request[v1.LoginServiceRequest]) (*connect.Response[v1.LoginServiceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.auth.v1.AuthService.LoginService is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) SignupService(context.Context, *connect.Request[v1.SignupServiceRequest]) (*connect.Response[v1.SignupServiceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.auth.v1.AuthService.SignupService is not implemented"))
}
