...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/imkrish7/ecoship-api/gen/proto/order/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	OrderServiceName = "proto.order.v1.OrderService"
)
...
// OrderServiceClient is a client for the proto.order.v1.OrderService service.
...
// NewOrderServiceClient constructs a client for the proto.order.v1.OrderService service. By
...
// CreateOrder calls proto.order.v1.OrderService.CreateOrder.
...
// AddToCart calls proto.order.v1.OrderService.AddToCart.
...
// GetOrderById calls proto.order.v1.OrderService.GetOrderById.
...
// GetOrders calls proto.order.v1.OrderService.GetOrders.
...
// CancelOrder calls proto.order.v1.OrderService.CancelOrder.
...
// CancelOrderItem calls proto.order.v1.OrderService.CancelOrderItem.
...
// RemoveItemFromCart calls proto.order.v1.OrderService.RemoveItemFromCart.
...
// ReturnOrderItems calls proto.order.v1.OrderService.ReturnOrderItems.
...
// IncreaseItemQuantity calls proto.order.v1.OrderService.IncreaseItemQuantity.
...
// DecreaseItemQuantity calls proto.order.v1.OrderService.DecreaseItemQuantity.
...
// OrderServiceHandler is an implementation of the proto.order.v1.OrderService service.
...
func NewOrderServiceHandler(svc OrderServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.order.v1.OrderService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOrderServiceHandler) CreateOrder(context.Context, *connect.Request[v1.CreateOrderRequest]) (*connect.Response[v1.CreateOrderResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.CreateOrder is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) AddToCart(context.Context, *connect.Request[v1.AddToCartRequest]) (*connect.Response[v1.AddToCartResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.AddToCart is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) GetOrderById(context.Context, *connect.Request[v1.GetOrderByIdRequest]) (*connect.Response[v1.GetOrderByIdResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.GetOrderById is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) GetOrders(context.Context, *connect.Request[v1.GetOrdersRequest]) (*connect.Response[v1.GetOrdersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.GetOrders is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) CancelOrder(context.Context, *connect.Request[v1.CancelOrderRequest]) (*connect.Response[v1.CancelOrderResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.CancelOrder is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) CancelOrderItem(context.Context, *connect.Request[v1.CancelOrderItemRequest]) (*connect.Response[v1.CancelOrderItemResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.CancelOrderItem is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) RemoveItemFromCart(context.Context, *connect.Request[v1.RemoveItemFromCartRequest]) (*connect.Response[v1.RemoveItemFromCartResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.RemoveItemFromCart is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) ReturnOrderItems(context.Context, *connect.Request[v1.ReturnOrderItemsRequest]) (*connect.Response[v1.ReturnOrderItemsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.ReturnOrderItems is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) IncreaseItemQuantity(context.Context, *connect.Request[v1.IncreaseItemQuantityRequest]) (*connect.Response[v1.IncreaseItemQuantityResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.IncreaseItemQuantity is not implemented"))
}
...
func (UnimplementedOrderServiceHandler) DecreaseItemQuantity(context.Context, *connect.Request[v1.DecreaseItemQuantityRequest]) (*connect.Response[v1.DecreaseItemQuantityResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.order.v1.OrderService.DecreaseItemQuantity is not implemented"))
}
